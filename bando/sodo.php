...
var map;
function initialize() {
      var myLatlng = new google.maps.LatLng(10.791011, 106.682249);
      var myOptions = {
    zoom: 16,
    center: myLatlng,
...
text= "<b style='color:#00F' " + 
         "style='text-align:center'>Shop cosplay<br />" + 
...
<body onLoad="initialize()">
    ...
    <table width="61%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="2%">&nbsp;</td>
        <td width="98%"><div align="center" class="style9"><strong>Shop cosplay</strong><br />
391A Nam kì khởi Nghĩa, Phường 7, Quận 3, TpHCM<br />
DĐ: 0934061820</div></td>
      </tr>
</table>
	<p>&nbsp;</p>
</body>
